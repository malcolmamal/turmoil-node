...
export const initializeStashAction = async () =>
  await Axios.get(`${servicePrefix}/initializeStash`);

export const onPolygonAction = async (polygonId) =>
  await Axios.block().get(
    `${servicePrefix}/instanceActionOnPosition/${polygonId}`,
  );
